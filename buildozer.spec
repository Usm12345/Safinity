...
requirements = python3,kivy==2.3.0,kivymd==1.1.1,python-dotenv,plyer,requests,tomli,pillow,setuptools,cython==0.29.36,pyjnius,android,sqlalchemy,bcrypt,cython,pillow,twilio
